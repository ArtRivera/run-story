...
import com.artrivera.core.presentation.design_system.RunStoryTransparent
import com.artrivera.core.presentation.design_system.RuniqueBlack
import com.artrivera.core.presentation.design_system.RuniqueGray

@Composable
fun RunStoryActionButton(
    text: String,
    isLoading: Boolean,
...
@Composable
fun RunStoryOutlinedActionButton(
    text: String,
    isLoading: Boolean,
    modifier: Modifier = Modifier,
    enabled: Boolean,
    ...
    OutlinedButton(
        onClick = onClick, enabled = enabled, colors = ButtonDefaults.buttonColors(
            ...
            containerColor = RunStoryTransparent
            ), shape = RoundedCornerShape(100f),
        border = BorderStroke(
            width = 0.5.dp,
